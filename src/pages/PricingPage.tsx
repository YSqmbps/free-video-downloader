import { Check, Zap, Crown, Star, Shield, Clock, Users, Headphones } from 'lucide-react';
import { pricingPlans } from '../data/platforms';

export default function PricingPage() {
  const benefits = [
    { icon: Shield, title: '安全可靠', desc: '采用最新加密技术，保护您的隐私' },
    { icon: Clock, title: '24/7服务', desc: '全天候服务，随时下载视频' },
    { icon: Users, title: '专业团队', desc: '专业技术团队提供支持' },
    { icon: Headphones, title: '专属客服', desc: 'VIP用户享受专属客服' },
  ];
